...
const layouts = [
  { id: "portrait", name: "Portrait", description: "Classic vertical layout" },
  { id: "landscape", name: "Landscape", description: "Wide horizontal layout" },
  { id: "square", name: "Square", description: "Perfect square format" },
];
